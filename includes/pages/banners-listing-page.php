...
function rg_ddeals_banner_listing_page() 
{
	global $wpdb;
	...
	$uploaddir = $base_dir.'/revglue/daily-deals/banners/';
	...
	?><div class="rg-admin-container add_banner_div <?php esc_html_e( $hide_form ) ?>">
		...
		<table class="form-table">
			...
			<tr id="rg_ddeals_banner_image_url" <?php echo ( empty ( $image_url ) ? 'style="display:none;"' : '' ); ?>>
				<th>
			...
			<tr id="rg_ddeals_banner_image_upload" <?php echo ( ! empty ( $image_url ) ? 'style="display:none;"' : '' ); ?>>
				<th>
	...
	<div class="rg-admin-container list_banner_div <?php esc_html_e( $hide_table ) ?>">
		...
		<div style="clear:both;"></div>
		<hr/>
		<div class="text-left bannersizedetail">
